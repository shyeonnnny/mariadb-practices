...
-- 실습문제1
-- 현재 회사 상황을 반영한 직원별 근무부서를 사번, 이름, 근무부서로 출력해보세요
-- 현재 -> 9999-01-01
...
-- 실습문제2
-- 현재회사에서 지급되고 있는 급여체계를 반영한 결과를 출력하세요.
-- 사번, 이름, 연봉 형태로 출력하세요.
select a.emp_no, a.first_name, b.salary
	from employees a, salaries b -- 조인조건은 변수 n-1개 만큼 필요
    where a.emp_no=b.emp_no
    and b.to_date = '9999-01-01'
    order by b.salary desc;
    
-- 예제 : 현재 직책별로 평균 연봉과 인원수를 구하되 직책별로 인원이 100명 이상인 직책만 줄력하세요.
select a.title, avg(salary),count(*)
 ...
 -- 에제 6 : 현재 부서별로 현재 직책이 Engineer인 직원들에 대해서만 평균급여를 구하세요.
...
-- 단, 총 합이 2,000,000,000이상인 직책만 나타내며 급여총합에 대해서 내림차룸으로 정렬하세요.
